...
gui.show_message("MODZCORE", "https://discord.gg/hgpXq5eK")

log.warning("ENJOY MODDING !!")

    MODZCORE = gui.get_tab("MODZCORE MENU ")
    MODZCORE:add_text("                      MODZCORE MENU 1.70 ")
    MODZCORE:add_text("                          Sb93Zoo ")


    moneymethods = MODZCORE:add_tab("MONEY METHODS")
    ranksmenu = MODZCORE:add_tab("RANKS")
    unlocks = MODZCORE:add_tab("UNLOCKS")


    
VehiclesMenu = MODZCORE:add_tab("VEHICLE MENU")
...
VehiclesMenu:add_button("ENABLE REMOVED VEHICLES", function()
    ...
    MissionEdit = MODZCORE:add_tab("MISSION EDITOR")
...
MissionEdit:add_separator()
    ...
    KDS = MODZCORE:add_tab("K/D EDITOR")
...
ilovecredits = MODZCORE:add_tab("C R E D I T S")

    MODZCOREi = ilovecredits:add_tab("Sb93")
    MODZCOREi:add_text("Rien à dire xD")
    MODZCOREi:add_text("Nothing to say xD")

    MODZCOREa = ilovecredits:add_tab("ModzCore")
    MODZCOREa:add_text("https://discord.gg/hgpXq5eK")
    MODZCOREa:add_text("https://www.youtube.com/@ModzCore")
